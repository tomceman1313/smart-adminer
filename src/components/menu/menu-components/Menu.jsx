	...
	return (
		<>
			{permissions.users && (
				...
				>
					<MenuLink
						title={t("userAccounts.usersList")}
						name="users"
						path="/users"
						activeLink={activeLink}
					/>
					<MenuLink
						title={t("userAccounts.rolesAndPrivileges")}
						name="roles"
						path="/roles"
						activeLink={activeLink}
					/>
			...
			{(permissions.pages ||
				...
				>
					...
					{permissions.gallery && (
						<MenuLink
							title={t("websiteContent.gallery")}
							name="gallery"
							path="/gallery"
							activeLink={activeLink}
						/>
					...
					{permissions.documents && (
						<MenuLink
							title={t("websiteContent.documents")}
							name="documents"
							path="/documents"
							activeLink={activeLink}
						/>
					...
					{permissions.pricelist && (
						<MenuLink
							title={t("websiteContent.priceList")}
							name="pricelist"
							path="/pricelist"
							activeLink={activeLink}
						/>
					...
					{permissions.notifications && (
						<MenuLink
							title={t("websiteContent.notifications")}
							name="notifications"
							path="/notifications"
							activeLink={activeLink}
						/>
